...
export const snapshotAPISubmitMessage = {
  uniqueId: DEFAULT_PROPOSAL_HASH,
};

export const snapshotAPIDraftResponse = {
  [DEFAULT_DRAFT_HASH]: {
...
export const snapshotAPIProposalResponse = {
  [DEFAULT_PROPOSAL_HASH]: {
    address: DEFAULT_ETH_ADDRESS,
    data: {
...
export const snapshotAPIOffchainProofResponse = {
  merkle_root:
